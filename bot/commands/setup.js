exports.run = async (client, message, args) => {
    ...
    if (!message.author.id === message.channel.guild.ownerID)
      ownerIDs.push(message.author.id);
    ...
    if (createRoom.success) {
      msg.edit(`**Success!** Your room is now live at **<https://exampleurl.com>** :sparkles:\nClick the link and login with Discord to join the room and start the adventure! \n\nYou can also change the **privacy** and **name** of your room in the game, learn more using the ${client.config.prefix}help command :)` )
    }
};
